...
const Submit = () => {
  ...
  return (
    <div className='bg-white p-5 md:p-7 md:my-0 my-10 rounded-xl min-w-[90%] md:min-w-[600px] flex flex-col'>
          ...
          onClick={() => {
            if (inputError.size === 0) {
              ...
              fetch("http://localhost:8083/", {
                body: `name=${name}&group=${group}&notes=${notes}&department=${department}`,
